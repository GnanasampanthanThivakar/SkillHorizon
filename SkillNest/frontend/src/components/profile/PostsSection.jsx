    ...
    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 max-w-6xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600">
          These are posts that you have added to your public SN SkillHorizon.{" "}
      ...
      {posts.length === 0 ? (
        <div className="border p-6 rounded-lg text-center text-gray-400 text-sm bg-gray-50 mb-6">
          You haven't added any posts to your public SkillHorizon profile.
        </div>
      ) : (
                ...
                <label className="flex items-center">
                  <input
                    ...
                    onChange={(e) =>
                      setEditForm({
                        ...editForm,
                        addToPortfolio: e.target.checked,
                      })
                    }
